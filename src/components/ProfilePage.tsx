...
import { User, Mail, Phone, MapPin, Calendar, Settings, Bell, Shield, CreditCard, BarChart3, Edit3, Save, X, Camera, Target, TrendingUp, Award, MessageSquare, Plus, Moon, Sun, Smartphone, Volume2 } from 'lucide-react';
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="bg-gray-900 rounded-2xl p-4 sm:p-6 border border-gray-800">
          ...
          {/* Primary Goal */}
          <div className="bg-gradient-to-r from-green-600/20 to-blue-600/20 border border-green-500/30 rounded-xl p-4 mb-4">
            <div className="flex items-center justify-between mb-3">
              <h4 className="font-semibold text-white text-sm sm:text-base">Lose 10 lbs by March 2024</h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 p-3 bg-gray-800 hover:bg-gray-700 rounded-lg text-gray-300 transition-colors text-sm">
              <Plus size={16} />
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
        ...
        <div className="bg-gray-900 rounded-2xl p-4 sm:p-6 border border-gray-800">
          <div className="flex items-center gap-2 mb-4">
            <MessageSquare size={20} className="text-blue-400" />
            <h3 className="text-base sm:text-lg font-semibold text-white">Get Help</h3>
          </div>
          <div className="bg-blue-600/20 p-4 rounded-lg border border-blue-500/30">
            <h4 className="font-medium text-blue-300 mb-2 text-sm sm:text-base">Questions about your profile?</h4>
            <p className="text-blue-200 text-xs sm:text-sm mb-3">
              Chat with Pat about your goals, progress, or account settings.
            </p>
            <button 
              onClick={() => onNavigate('chat')}
